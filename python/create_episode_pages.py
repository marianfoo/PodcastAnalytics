...
metadataApiClass = metadataApi(str(Path().resolve().parent.resolve()) + '/podcastssssss/docs/_data/data.json')
...
def createEpisodePages(show,permalink_show,folder_name,grand_parent):
    ...
    for episode in metadata_json[show]['all_episodes']:
        ...
        with open(str(Path().resolve().parent.resolve()) + '/podcastssssss/docs/_pages/' + folder_name + '/episodes/' + safeTitle + '.md', 'w',encoding="utf-8") as f:
